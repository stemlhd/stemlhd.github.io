        ...
        var $this = $(this).html(
          event.strftime(
            "" +
              ...
              '<span class="csi-days">%D <i class="white-bg"> DAYS </i></span> ' +
              '<span class="csi-hr">%H <i class="white-bg"> HRS </i></span> ' +
              '<span class="csi-min">%M <i class="white-bg"> MINS </i></span> ' +
              '<span class="csi-sec">%S <i class="white-bg"> SECS </i></span>'
          )
        );
      });
    }
      ...
      if (isEmail(emailInput.val())) {
        ...
        $.ajax({
          ...
          success: function(ajaxResponse) {
            ...
            $("#csi-subalert")
              .addClass("alert alert-success csi-sub-alert")
          ...
          error: function(argument) {
            var ajaxResponse = $.parseJSON(ajaxResponse);
            $("#csi-subalert")
              .addClass("alert alert-danger csi-sub-alert")
              .html(ajaxResponse.message);
            // body...
          }
        });
